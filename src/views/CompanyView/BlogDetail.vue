    ...
    <div class="container">
        ...
        <div v-if="blogs.length">
            <div v-for="blog in blogs" :key="blog.blogId" class="blog-summary">
                ...
                <p class="blog-content-preview">{{ blog.blogContent.slice(0, 100) }}...</p>
                <div class="heart-container">
                    <button @click="toggleEmotion(blog.blogId, user.id)" :class="{'active': blog.isLiked}" class="btn btn-heart">❤️</button>
